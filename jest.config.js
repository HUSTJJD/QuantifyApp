module.exports = {
  ...
  testPathIgnorePatterns: [
    ...
    '/dukascopy-node/',
    '/myhhub-stock/',
    // 真网联调用例：默认跳过；需要时 RUN_LIVE_TESTS=1 且单独指定路径
    '/tests/data/apiLive\\.test\\.ts',
    '/tests/data/sourceContract\\.test\\.ts',
    '/tests/data/MarketDataClient\\.test\\.ts',
    '/tests/data/MarketDataSources\\.test\\.ts',
  ],
  ...
  moduleNameMapper: {
    ...
    '^@opptrix/fuyao$': '<rootDir>/FuyaoNPM/src/index.ts',
